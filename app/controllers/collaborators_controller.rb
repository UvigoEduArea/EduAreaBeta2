# -*- coding: utf-8 -*-
class CollaboratorsController < ResourcesController
  ...
  ###########################################################################
  ##                   COLLABORATORS DUPLICATE                             ##
  ###########################################################################
  
  api :POST, "/collaborators/duplicate.json", "Duplica un colaborador"
  param :id, Fixnum, :desc => "Id del colaborador que se quiere duplicar", :required => true
  formats ['json']
   example '{
    "id": 274
}'
  ...
  api :GET, "/:locale/collaborators/:id/getComments", "Get Comments"
  ...
  api :POST, "/:locale/collaborators/:id/setComments", "Set Comments"
