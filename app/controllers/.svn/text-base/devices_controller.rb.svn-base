# -*- coding: utf-8 -*-
class DevicesController < ResourcesController
  ...
  api :POST, "/devices/duplicate.json", "Duplica un device"
  param :id, Fixnum, :desc => "Id del device que se quiere duplicar", :required => true
  formats ['json']
   example '{
    "id": 274
}'
  ...
  api :GET, "/:locale/devices/:id/getComments", "Get Comments"
  ...
  api :POST, "/:locale/devices/:id/setComments", "Set Comments"
